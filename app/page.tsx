...
export default function AddsysWeb() {
  const heroImages = [
    ...
    {src:"/Images/F_OB/HERO2.png",
     position: "center 50%",
     scale: "1",
    },
    {src:"/Images/F_OB/HERO10.jpg",
     position: "center 50%",
     scale: "1",
    },
    {src:"/Images/F_OB/HERO100.jpg",
     position: "center 100%",
     scale: "1",
    },
    {src:"/Images/F_OB/HERO203.jpg",
     position: "center 20%",
     scale: "1",
    },
    {src:"/Images/F_OB/HERO200.png",
     position: "center 50%",
     scale: "1",
    },
    {src:"/Images/F_OB/HERO204.jpg",
     position: "center 50%",
     scale: "1",
    },
    {src:"/Images/F_OB/HERO202.jpg",
     position: "center 100%",
     scale: "1",
    },
  ...
  useEffect(() => {
    ...
    const interval = window.setInterval(() => {
      ...
      const firstCard = container.querySelector("[data-carousel-item]") as HTMLDivElement | null;
  ...
  const whatsappMessage = encodeURIComponent("Hola, quiero hablar de mi infraestructura sanitaria");
  ...
  <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center border-b border-slate-200">
    ...
    <nav className="hidden lg:flex items-center gap-6 text-sm font-medium text-slate-700">
      <a href="#inicio" className="transition hover:text-sky-700">Inicio</a>
      <a href="#servicios" className="transition hover:text-sky-700">Servicios</a>
      <a href="#proyectos" className="transition hover:text-sky-700">Proyectos</a>
      <a href="#clientes" className="transition hover:text-sky-700">Clientes</a>
  ...
  {mobileMenuOpen && (
    <div className="lg:hidden border-t border-slate-200 bg-white px-6 py-4 shadow-sm">
      <nav className="flex flex-col gap-4 text-sm font-medium text-slate-700">
        <a href="#inicio" onClick={() => setMobileMenuOpen(false)} className="transition hover:text-sky-700">Inicio</a>
        <a href="#servicios" onClick={() => setMobileMenuOpen(false)} className="transition hover:text-sky-700">Servicios</a>
        <a href="#proyectos" onClick={() => setMobileMenuOpen(false)} className="transition hover:text-sky-700">Proyectos</a>
        <a href="#clientes" onClick={() => setMobileMenuOpen(false)} className="transition hover:text-sky-700">Clientes</a>
    ...
    <div className="order-2 md:order-1">
      ...
      <div className="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl">
        ...
        <div className="rounded-2xl border bg-white p-4 shadow-sm">
          ...
          <div className="text-lg font-semibold text-sky-700">Temuco, Chile</div>
        </div>
        ...
        <div className="rounded-2xl border bg-white p-4 shadow-sm col-span-2 md:col-span-1">
          ...
          <div className="text-lg font-semibold text-sky-700">Todo el país</div>
        </div>
      </div>
    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-b from-slate-50 to-white rounded-[2rem] p-10 shadow-sm border border-slate-200">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl">
              Entregamos soluciones sanitarias completas para que tu proyecto funcione sin problemas, cumpla normativa y se ejecute de forma eficiente.
            </p>

            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 mt-10">
              {services.map((s) => (
                <div key={s.title} className="border border-slate-200 bg-white p-6 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition duration-300">
            ...
            <div className="mt-20">
              <h2 className="text-3xl md:text-4xl font-bold">¿Por qué elegir ADDSYS?</h2>

              <div className="grid md:grid-cols-3 gap-6 mt-10">
                {trustPoints.map((point) => (
                  <div key={point.title} className="p-6 border border-slate-200 rounded-2xl bg-white shadow-sm hover:shadow-lg hover:-translate-y-1 transition">
...
<div className="mt-10">
  <div className="rounded-2xl border border-slate-200 bg-gradient-to-r from-sky-50 to-white p-8 shadow-sm">
    ...
    <p className="mt-4 text-gray-600 leading-7 md:text-justify">
      En ADDSYS contamos con personal técnico especializado y experiencia en terreno,
      lo que nos permite abordar cada proyecto con criterio profesional, eficiencia
      y soluciones adaptadas a la realidad de cada cliente.
    </p>

    <p className="mt-4 text-gray-600 leading-7 md:text-justify">
      Nuestro equipo combina conocimiento técnico y experiencia práctica, destacando
      la trayectoria de nuestro Gerente de operaciones, con más de 15 años de experiencia
      en empresas sanitarias, desarrollando nuevos negocios del rubro y 8 años como
      contratista en proyectos para empresas sanitarias y clientes industriales.
    </p>

    <div className="mt-6 grid sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm text-slate-600">
      <div>• Profesionales con experiencia en el rubro sanitario</div>
      <div>• Conocimiento técnico en agua potable y aguas servidas</div>
      <div>• Enfoque práctico en ejecución y resolución de problemas</div>
    </div>
...
<section id="proyectos" className="scroll-mt-7 bg-gradient-to-b from-white to-gray-100 py-24">
  <div className="max-w-7xl mx-auto px-6">
    <div className="overflow-visible rounded-3xl shadow-lg border border-gray-200 bg-white p-8">
      ...
      <p className="mt-4 text-gray-600 max-w-2xl">
        Una propuesta visual que transmite experiencia, terreno y ejecución técnica, reforzando la confianza comercial de ADDSYS.
      </p>
      ...
      <div className="max-w-5xl mx-auto mt-10">
        <div className="grid md:grid-cols-2 gap-6">
          {[
            { img: "/Images/F_OB/Grid1.jpg", titulo: "Planta elevadora de agua servida", tipo: "Proyecto domiciliario" },
            { img: "/Images/F_OB/Grid2.jpg", titulo: "Planta elevadora de agua potable", tipo: "Proyecto domiciliario" },
            { img: "/Images/F_OB/Grid3.png", titulo: "Instalación sanitaria", tipo: "Obra de infraestructura pública, Agua Potable" },
            { img: "/Images/F_OB/Grid4.png", titulo: "Instalación sanitaria", tipo: "Obra de infraestructura pública, Agua Servida" },
          ].map((item, i) => (
      ...
      <div className="w-full mt-16 px-6 md:px-10">
        ...
        <div className="relative rounded-3xl border border-gray-200 bg-white shadow-xl">
          ...
          <div
            ...
            {[
              { img: "/Images/100.jpeg", titulo: "Planta elevadora de agua potable(PEAP)", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/101.jpeg", titulo: "Pozo de absorción", ubicacion: "Sistema particular de agua servida rural" },
              { img: "/Images/102.jpeg", titulo: "Planta elevadora de agua servida(PEAS)", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/103.jpeg", titulo: "PEAS", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/104.jpeg", titulo: "Tablero de fuerza y control", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/105.jpeg", titulo: "Limpieza de sistemas domiciliarios de agua servida", ubicacion: "Infraestructura interior sanitaria" },
              { img: "/Images/106.jpeg", titulo: "Conexiones a redes públicas de agua servida", ubicacion: "Sistemas sanitarios urbanos" },
              { img: "/Images/107.jpeg", titulo: "Conexiones a redes públicas", ubicacion: "Sistemas sanitarios urbanos" },
              { img: "/Images/108.jpeg", titulo: "Conexiones a redes públicas", ubicacion: "Sistemas sanitarios urbanos" },
              { img: "/Images/109.jpeg", titulo: "Limpieza de sistemas domiciliarios de agua servida", ubicacion: "Infraestructura interior sanitaria" },
              { img: "/Images/110.jpeg",  titulo: "Limpieza de sistemas domiciliarios de agua servida", ubicacion: "Infraestructura interior sanitaria" },
              { img: "/Images/111.jpeg", titulo: "Conexiones a redes públicas", ubicacion: "Sistemas sanitarios urbanos" },
              { img: "/Images/F_OB/Carr1.jpg", titulo: "PEAS", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/F_OB/Carr2.jpg", titulo: "PEAS", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/F_OB/Carr5.jpg", titulo: "Tablero de fuerza y control", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/F_OB/Carr6.jpg", titulo: "Tablero de fuerza y control", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/F_OB/Carr11.png", titulo: "Conexiones a redes públicas", ubicacion: "Sistemas sanitarios urbanos" },
              { img: "/Images/F_OB/Carr12.jpg", titulo: "Sistema interior de agua servida", ubicacion: "Proyecto domiciliario" },
              { img: "/Images/F_OB/Carr14.png", titulo: "Pozo de absorción", ubicacion: "Sistema particular de agua servida rural" },
              { img: "/Images/F_OB/Carr15.png", titulo: "Redes púbicas e interiores de agua servida", ubicacion: "Red pública" },
              { img: "/Images/F_OB/Carr16.png", titulo: "Redes púbicas e interiores de agua servida", ubicacion: "Red pública" },
              { img: "/Images/F_OB/Carr17.png", titulo: "Soluciones particulares de agua servida", ubicacion: "Proyecto rural" },
              { img: "/Images/F_OB/Carr18.png", titulo: "Red interior de agua servida", ubicacion: "Sistemas sanitarios urbanos" },
              { img: "/Images/F_OB/Carr19.png", titulo: "Sistema particular de agua servida", ubicacion: "Sistema sanitario rural" },
              { img: "/Images/F_OB/Carr20.png", titulo: "Sistema particular de agua servida", ubicacion: "Sistema sanitario rural" },
              { img: "/Images/F_OB/Carr30.jpg", titulo: "Sistema particular de agua potable", ubicacion: "Sistema sanitario rural" },
              { img: "/Images/F_OB/Carr40.png", titulo: "Sistema particular de agua potable", ubicacion: "Sistema sanitario rural" },
              { img: "/Images/F_OB/Carr62.jpg", titulo: "Operación Planta de Tratamiento de Aguas Servidas", ubicacion: "Sistema sanitario rural" },
              { img: "/Images/F_OB/Carr63.jpg", titulo: "Operación Planta de Tratamiento de Aguas Servidas", ubicacion: "Sistema sanitario rural" },
              { img: "/Images/F_OB/Carr64.jpg", titulo: "Operación Planta de Tratamiento de Aguas Servidas", ubicacion: "Sistema sanitario rural" }
...
<div key={i} className="w-[220px] sm:w-[320px] md:w-[340px] flex-none snap-center group">
        ...
        <p className="text-sm text-gray-500 mt-3">Desliza para ver más proyectos →</p>
      </div>
  </div>
  </div>
</section>
...
<section id="clientes" className="scroll-mt-7 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-gradient-to-b from-slate-50 to-white rounded-[2rem] p-10 shadow-sm border border-slate-200">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl">
              Empresas e instituciones que han confiado en ADDSYS para el desarrollo de sus proyectos sanitarios.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mt-10 items-center">
              {[
                ...
                <div key={i} className="flex items-center justify-center p-4 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition">
                  <img
                    src={logo}
                    alt={`Cliente ${i + 1}`}
...
{/* COBERTURA */}
<section id="cobertura" className="py-24 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto px-6">
  ...
  En ADDSYS contamos con capacidad para desarrollar proyectos sanitarios a nivel nacional,
  con experiencia en distintas condiciones geográficas y operativas. Nos adaptamos a las
  necesidades de cada cliente, asegurando soluciones eficientes tanto en zonas urbanas
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="mt-4 text-slate-300 leading-8">
                En ADDSYS llevamos más de 8 años desarrollando soluciones sanitarias desde Temuco,
                apoyando proyectos de agua potable y aguas servidas en toda la zona sur del país.
              </p>

              <p className="mt-4 text-slate-300 leading-8">
                Cuéntanos tu requerimiento y te orientamos con una solución técnica clara, práctica
                y ajustada a tu proyecto.
              </p>

              <div className="mt-8 space-y-3 text-sm text-slate-300">
                <div>✔ Experiencia en proyectos domiciliarios, urbanos e industriales</div>
            ...
            <div className="bg-white text-gray-800 rounded-2xl p-8 shadow-xl">
              ...
              <form
                ...
                className="space-y-4"
              >
                <input type="hidden" name="_subject" value="Nueva solicitud desde addsys.cl" />
                <input type="hidden" name="_template" value="table" />
                <input type="hidden" name="_next" value="https://addsys.cl/gracias" />
...
<footer className="border-t border-slate-200 bg-white py-12">
  <div className="max-w-7xl mx-auto px-6">
      ...
      <div>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-sm text-slate-500">Ingeniería Sanitaria</div>
          </div>
        </div>

        <p className="mt-4 text-sm leading-7 text-slate-500 max-w-md text-justify [text-align-last:left]">
          Soluciones sanitarias en agua potable y aguas servidas, con experiencia
          en proyectos domiciliarios, urbanos e industriales desde Temuco para todo Chile.
        </p>
      </div>
    ...
    <div className="mt-10 border-t border-slate-200 pt-6 flex flex-col gap-2 md:flex-row md:items-center md:justify-between text-xs text-slate-400">
      <div>© {new Date().getFullYear()} ADDSYS SpA. Todos los derechos reservados.</div>
